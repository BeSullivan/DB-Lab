CREATE USER Admins WITH PASSWORD '111111' CREATEDB;

CREATE ROLE beStudent WITH NOCREATEDB NOCREATEROLE;
CREATE ROLE beManager WITH NOCREATEDB NOCREATEROLE;
CREATE ROLE beTeacher WITH NOCREATEDB NOCREATEROLE;

GRANT SELECT ,UPDATE ,DELETE ,INSERT ON Student ,Teacher TO beManager;
GRANT SELECT ON Student TO beStudent;
GRANT UPDATE ON Student(S_Tele ,S_Addr) TO beStudent;
